...
public class DoctorConfiguration : IEntityTypeConfiguration<Doctor>
{
    public void Configure(EntityTypeBuilder<Doctor> builder)
    {
        ...
        builder.Property(d => d.Document).IsRequired().HasColumnType("NVARCHAR(11)");
        builder.HasIndex(d => d.Document).IsUnique();
        builder.Property(d => d.CRM).IsRequired().HasColumnType("NVARCHAR(8)");
        builder.HasIndex(d => d.CRM).IsUnique();
        builder.Property(d => d.PhoneNumber).IsRequired().HasColumnType("NVARCHAR(11)");
