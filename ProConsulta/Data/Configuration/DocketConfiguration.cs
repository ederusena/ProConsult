...
namespace ProConsulta.Data.Configuration
{
    public class DocketConfiguration : IEntityTypeConfiguration<Docket>
    {
        public void Configure(EntityTypeBuilder<Docket> builder)
        {
            ...
            builder.Property(d => d.Observation).IsRequired(true).HasColumnType("VARCHAR(200)");
            builder.Property(d => d.DoctorId).IsRequired(true);
            builder.Property(d => d.PatientId).IsRequired(true);
            builder.Property(d => d.DateConsult).IsRequired(true);
