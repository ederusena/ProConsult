...
public class DbInitializer
{
    ...
    internal void seed()
    {
        ...
        (
            ...
            new Speciality
                { Id = 2, Name = "Neurologia", Description = "Especialidade que trata doenças do sistema nervoso" },
            new Speciality
                { Id = 3, Name = "Dermatologia", Description = "Especialidade que cuida da pele, cabelos e unhas" },
            new Speciality
                { Id = 4, Name = "Pediatria", Description = "Especialidade médica dedicada à saúde das crianças" },
            new Speciality
            {
            ...
            new Speciality
                { Id = 7, Name = "Oftalmologia", Description = "Especialidade que cuida da saúde dos olhos" },
            new Speciality { Id = 8, Name = "Psiquiatria", Description = "Especialidade que trata doenças mentais" },
            new Speciality
            {
                Id = 9, Name = "Endocrinologia",
                Description = "Especialidade que trata doenças relacionadas ao sistema endócrino"
            },
            new Speciality
                { Id = 10, Name = "Gastroenterologia", Description = "Especialidade que cuida do sistema digestivo" },
            new Speciality
                { Id = 11, Name = "Nefrologia", Description = "Especialidade que cuida dos rins e do sistema urinário" }
        );
    }
}